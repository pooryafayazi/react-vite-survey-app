  ...
  const rows = useMemo(() => {
    return questions.map((q, i) => {
      ...
      if (q.type === 'multi'){
        ...
        return { no: i+1, title: q.title, content: (
            ...
            <motion.div initial={{opacity:0, y:12}} animate={{opacity:1, y:0}} transition={{duration:.25}}>
              <Card className="border-0 shadow-sm">
                <Card.Body className="text-center">
                  ...
                  <h1 className="h4 mb-1">با تشکر! پاسخ‌های شما ثبت شد.</h1>
                  <p className="text-muted mb-4">مرور خلاصهٔ پاسخ‌ها در همین صفحه:</p>
                    ...
                    <>
                      <div className="text-start">
                        ...
                        <details className="mt-2">
                          <summary>نمایش JSON خام (اختیاری)</summary>
                          <pre className="mt-3 bg-light p-3 rounded small code-box">{json}</pre>
                        </details>
                      </div>
